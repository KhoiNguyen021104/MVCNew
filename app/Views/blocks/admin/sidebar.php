...
<div class="sidebar w-100" style="height: 100vh !important;">
  <div class="h-100 sidebar-container d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" bis_skin_checked="1">
    ...
    <li>
      ...
      <li>
        <a style="color: #000;" href="<?php echo _HOST_PATH_?>/admin/Devices" class="nav-link sidebar-item <?php if(isset($activeDevices)) {
          if(!empty($activeDevices)) echo 'active fw-bold text-light';
        } ?>">
          <svg class="bi pe-none me-2" width="16" height="16">
            <use xlink:href="#table"></use>
          </svg>
          Thuê thiết bị, dụng cụ
        </a>
      </li>
      <li>
      ...
      <li>
        <a style="color: #000;" href="<?php echo _HOST_PATH_?>/admin/Account" class="nav-link sidebar-item <?php if(isset($activeAccount)) {
          if(!empty($activeAccount)) echo 'active fw-bold text-light';
        } ?>">
          <svg class="bi pe-none me-2" width="16" height="16">
            <use xlink:href="#table"></use>
          </svg>
