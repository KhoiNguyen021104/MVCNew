<div class="container mt-2 px-3" style="max-width: 100% !important;">
    ...
    <div class="detail mt-3 w-50 m-auto">
        <form action="" method="post">
            ...
            <div class="mb-3">
                <label for="">Quy định</label>
                <input disabled type="text" name="age_limit" id="" class="form-control" 
                value="<?php
                    echo($detail['age_limit']!=0?('Trên ' . $detail['age_limit'] . ' tuổi'):'Không giới hạn độ tuổi');
                    echo ' và chiều cao ';
                    if($detail['height_limit']==1) echo 'từ 1m - 1,3m';
                    else if($detail['height_limit'] == 1.3) echo ' trên 1,3m';
                 ?>
                 ">
            </div>
            <div class="mb-3 d-flex justify-content-between">
