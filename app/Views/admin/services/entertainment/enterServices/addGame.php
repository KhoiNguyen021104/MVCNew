        ...
        <form action="<?php echo _HOST_PATH_ ?>/admin/EnterServices/postAddEnterServices" method="post" class="w-50">
            ...
            <div class="mb-3 d-flex">
                ...
                <div class="w-50">
                    ...
                    <!-- <input required type="text" name="height_limit" id="" class="form-control" placeholder="Nhập quy định khác (nếu có)" value="<?php echo (isset($old['enterservice_regulations']) ? $old['enterservice_regulations'] : '') ?>"> -->
                    <select name="height_limit" id="" class="form-control">
                        <option value="0">Không giới hạn</option>
                        <option value="1">Từ 1m - 1,3m</option>
                        <option value="1.3">Trên 1,3m</option>
                    </select>
                </div>
            </div>
            <div class="mb-3">
